...
export const fiscalYear = {
  ...
  metrics: [
    {
      value: "US$ 331,8 bi",
      spoken: "331,8 bilhões de dólares",
      amount: 331.8,
      decimals: 1,
      delta: "+18%",
      growth: 18,
      color: "red" as SquareColor,
      label: "Receita anual",
      note: "Alta de 16% em moeda constante.",
    },
    {
      value: "US$ 155,2 bi",
      spoken: "155,2 bilhões de dólares",
      amount: 155.2,
      decimals: 1,
      delta: "+21%",
      growth: 21,
      color: "green" as SquareColor,
      label: "Resultado operacional",
      note: "Margem operacional em expansão no período.",
    },
    {
      value: "US$ 59,3 bi",
      spoken: "59,3 bilhões de dólares",
      amount: 59.3,
      decimals: 1,
      delta: "+27%",
      growth: 27,
      color: "blue" as SquareColor,
      label: "Microsoft Cloud no 4º tri",
      note: "Receita de nuvem no trimestre encerrado em junho.",
    },
    {
      value: "US$ 678 bi",
      spoken: "678 bilhões de dólares",
      amount: 678,
      decimals: 0,
      delta: "+84%",
      growth: 84,
      color: "yellow" as SquareColor,
